...
var Counter = () => {
  const [counter, setCounter] = import_react2.useState(0);
  ...
  }, "-"), import_react.default.createElement("h2", null, counter));
};
var Counter_default = Counter;

// src/components/HeaderLayout.tsx
var import_react3 = __toESM(require_react(), 1);
var HeeaderLayout = (props) => {
  return import_react3.default.createElement("div", {
    className: "header-layout"
  }, import_react3.default.createElement("div", null, props.children), import_react3.default.createElement("h1", {
    className: "text-4xl text-center text-rose-500 font-bold underline"
  }, props.title));
};
var HeaderLayout_default = HeeaderLayout;

// src/components/UsersList/index.tsx
var import_react4 = __toESM(require_react(), 1);
var UsersList = (props) => {
  const isLoading = false;
  return import_react4.default.createElement("ul", {
    className: ""
  }, props.users.map((user) => import_react4.default.createElement("li", {
    key: user.id
  }, user.name)));
};
...
function App() {
  const [users, setUsers] = import_react5.useState([]);
  const [state, setState] = import_react5.useState({
    isLoading: false,
    error: null
  });
  ...
  return import_react6.default.createElement("html", null, import_react6.default.createElement("head", null, import_react6.default.createElement("meta", {
    charSet: "utf-8"
  ...
  }), import_react6.default.createElement("title", null, "My app")), import_react6.default.createElement("body", null, import_react6.default.createElement("div", {
    id: "root"
  }, import_react6.default.createElement(HeaderLayout_default, {
    title: "Users App"
  }, import_react6.default.createElement("img", {
    src: "/logo.svg",
    alt: "Login"
  })), users && import_react6.default.createElement(UsersList_default, {
    users
  }), import_react6.default.createElement("br", null), import_react6.default.createElement("hr", null), import_react6.default.createElement(Counter_default, null))));
}

// src/main.tsx
client.hydrateRoot(document, import_react7.default.createElement(App, null));
