...
e?.$passthrough&&// @ts-ignore
(e=e[e.$passthrough]),isNotEmpty(n.headers)||200!==n.status||n.redirect||n.cookie)switch("string"==typeof n.status&&(n.status=s[n.status]),n.redirect&&(n.headers.Location=n.redirect,(!n.status||n.status<300||n.status>=400)&&(n.status=302)),n.cookie&&isNotEmpty(n.cookie)&&(n.headers["Set-Cookie"]=cookieToHeader(n.cookie)),n.headers["Set-Cookie"]&&Array.isArray(n.headers["Set-Cookie"])&&(n.headers=parseSetCookies(new Headers(n.headers),n.headers["Set-Cookie"])),e?.constructor?.name){case"String":case"Blob":return new Response(e,n);case"Object":case"Array":return Response.json(e,n);case"ReadableStream":return n.headers["content-type"]?.startsWith("text/event-stream")||(n.headers["content-type"]="text/event-stream; charset=utf-8"),new Response(e,n);case void 0:if(!e)return;return Response.json(e,n);case"Response":let o=Object.assign({},n.headers);if(r)// @ts-ignore
n.headers=e.headers.toJSON();else for(let[s,t]of e.headers.entries())s in n.headers||(n.headers[s]=t);for(let s in o)e.headers.append(s,o[s]);return e.status!==n.status&&(n.status=e.status),e;case"Promise":// @ts-ignore
